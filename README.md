...
- **小項目**：三種類型——🟢 工作項目、🟣 會議安排、🟠 作業；三者都可以填選填的時間
- 年度／季度／月份／特定日期四種範圍篩選
- **循環規則**：每週、每兩週、每月或每季，遇假日可選「順延／提前至工作天／不調整」，可設循環期限（每週類的星期幾由起始日期決定）
- 循環的某一次可以單獨改日期或整次略過，不影響其他週期
- 自訂假日清單（週六日已自動視為假日），可一次貼上多個日期批次加入
...
- **操作記錄**：共享項目被誰在什麼時候改過都看得到，保留 90 天
