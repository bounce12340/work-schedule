...
- **免費版與 Pro**：免費版沒有期限，但大項目與專案各最多 3 個、AI 小幫手每天 5 次；Pro 不限（AI 20 次）。Pro 到期後資料一個都不刪，只是不能再新增。訂閱在 iPhone app 內進行（尚未推出），網頁版共用同一份訂閱
...
| iOS app | 免費下載，Pro 為 app 內訂閱（尚未推出）；一個 Apple ID 一個帳號。前端每次改版都要重新打包送審。陌生人只能在 app 裡註冊 |
